...
<ol>
  <li><strong>拖拽起手</strong>：想要给当前节点后面接一个大模型或者代码清洗步骤，你必须先把鼠标挪到屏幕最左侧的节点菜单；</li>
  <li><strong>长途搬运</strong>：找到对应的卡片，按住鼠标拖进画布；</li>
  <li><strong>寻找空位</strong>：小心翼翼在空白处找准位置放下；</li>
  <li><strong>对准端口</strong>：再把视线拉回到刚才的上游节点，拉住输出端口，对准新节点的输入端口连上去。</li>
</ol>

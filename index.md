...
<span class="c-magenta">##</span> <span class="c-yellow">最新动态 · LATEST_LOGS</span>
...
{% if post.summary %}<span class="log-summary">  └─ {{ post.summary | truncate: 32 }}</span>{% endif %}</div>
{% endfor %}

<span class="c-magenta">##</span> <span class="c-yellow">系统状态 · SYS_STATUS</span>

- 身份定位：支持家族企业稳定运转 / 探索数字游民
...
- Role: Supporting family business stability / Exploring digital nomadism
- Work Env: <span class="c-cyan">Distributed / Remote</span>
- Core Output: Product Management, Remote Workflow, Tech Verification
</div>
